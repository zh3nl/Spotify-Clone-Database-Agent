...
/**
 * Represents a database table for recently played tracks
 */
export interface RecentlyPlayedTracksTable {
  id: string;
  user_id: string;
  track_id: string;
  title: string;
...
/**
 * Represents the schema for inserting a track into the recently played tracks table
 */
...
/**
 * Represents a database table for track listening history
 */
export interface TrackListeningHistoryTable {
  id: string;
  user_id: string;
  track_id: string;
  played_at: string;
...
/**
 * Represents the schema for inserting a record into the track listening history table
 */
export interface TrackListeningHistoryInsert {
  user_id: string;
  track_id: string;
  played_at: string;
  context_type?: string;
...
/**
 * Represents the schema for inserting an album into the albums table
 */
...
/**
 * Represents a database table for playlists
 */
...
/**
 * Represents the schema for inserting a playlist into the playlists table
 */
...
/**
 * Represents a database table for track details
 */
...
/**
 * Represents the schema for inserting a track into the tracks table
 */
...
/**
 * Represents a database table for artists
 */
...
/**
 * Represents the schema for inserting an artist into the artists table
 */
...
/**
 * Represents a database table for track-artist relationships
 */
export interface TrackArtistsTable {
  id: string;
  track_id: string;
  artist_id: string;
  created_at: string;
...
/**
 * Represents the schema for inserting a track-artist relationship
 */
export interface TrackArtistsInsert {
  track_id: string;
  artist_id: string;
}

/**
 * Represents a database table for user listening history aggregations
 */
export interface ListeningHistoryAggregationsTable {
  id: string;
  user_id: string;
  period: string;
  date: string;
...
/**
 * Represents the schema for inserting a listening history aggregation
 */
export interface ListeningHistoryAggregationsInsert {
  user_id: string;
  period: string;
  date: string;
  track_count: number;
