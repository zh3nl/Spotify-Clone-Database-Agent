...
-- Generated: 2025-07-20T20:43:37.579Z
-- Use this script to populate your recently_played table with seed data

INSERT INTO recently_played ("track_id", "user_id", "title", "artist", "album", "image_url", "played_at", "duration", "created_at", "updated_at")
VALUES
...
ON CONFLICT ("user_id", "track_id") DO UPDATE SET "track_id" = EXCLUDED."track_id", "user_id" = EXCLUDED."user_id", "title" = EXCLUDED."title", "artist" = EXCLUDED."artist", "album" = EXCLUDED."album", "image_url" = EXCLUDED."image_url", "played_at" = EXCLUDED."played_at", "duration" = EXCLUDED."duration", "updated_at" = EXCLUDED."updated_at";
